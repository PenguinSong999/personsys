...
$.ajax({
    method:'post',
    url:'${pageContext.request.contextPath}/static/echartsData',
    dataType:'json',
...
$.ajax({
    method:'post',
    url:'${pageContext.request.contextPath}/static/echartsData1',
    dataType:'json',
    success:function(data){
        initChat1(data);
    }
...
<div style="width:100%;height:190%;margin-top:-30px; border:0;" class="main_tabbor">
	...
	$.ajax({
	    method:'post',
	    url:'${pageContext.request.contextPath}/static/echartsData2',
	    dataType:'json',
	    success:function(data){
...
$.ajax({
    method:'post',
    url:'${pageContext.request.contextPath}/static/echartsData3',
    dataType:'json',
    success:function(data){
        initChat3(data);
    }
