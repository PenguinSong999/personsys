...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm"  action="${pageContext.request.contextPath}/employee/update">
        <input type="hidden" name="id" id="id" value="${employee.id }" >
        <input type="hidden" name="createdate"  value="${employee.createdate }" >
