...
<html>
  ...
  <body>
    <div class="x-nav">
      ...
      <button type="button" onclick="location.href='${pageContext.request.contextPath}/file/addpage'" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:inherit;margin-left:75%;"  ><i class="layui-icon"></i>上传文件</button>
      <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${pageContext.request.contextPath}/file/listdata" title="刷新">
        <i class="layui-icon" style="line-height:30px">ဂ</i></a>
    </div>
    <div class="x-body">
      <div class="layui-row" style="" align="center">
        <form class="layui-form layui-col-md12 x-so" method="get" action="${pageContext.request.contextPath}/job/querylist">
      ...
      layui.use('table', function(){
          ...
          table.render({
              ...
              ,cols: [[
                  ...
                  ,{field:'remark', width:150, title: '文件描述', align: 'center'}
                  ,{field:'createdate', width:150, title: '创建时间', align: 'center'}
                  ,{field:'username', width:150, title: '上传人', align: 'center',templet:function (res) {
          ...
          table.on('tool(demo)', function(obj){
              ...
              if(obj.event === 'del'){
                  layer.confirm('真的删除行么', function(index){
                      $.post("/file/deletefile",{id:data.id},function () {
