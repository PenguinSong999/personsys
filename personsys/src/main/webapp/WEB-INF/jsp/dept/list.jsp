...
<body>
	<div class="x-nav">
		...
		<button type="button" onclick="location.href='${pageContext.request.contextPath}/dept/addpage'" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:inherit;margin-left:75%;"  ><i class="layui-icon"></i>增加</button>
		<a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${pageContext.request.contextPath}/dept/listdata" title="刷新">
			<i class="layui-icon" style="line-height:30px">ဂ</i></a>
	</div>
	<div class="x-body">
		<div class="layui-row" style="" align="center">
			<form class="layui-form layui-col-md12 x-so" method="get"
				action="${pageContext.request.contextPath}/dept/querylist">
	...
	layui.use('table', function(){
		...
		table.render({
			...
			,cols: [[
				...
				,{field:'name', width:150, title: '部门名称', align: 'center'}
				,{field:'remark', width:150, title: '详细信息', align: 'center'}
		...
		table.on('tool(demo)', function(obj){
			...
			if(obj.event === 'del'){
				layer.confirm('真的删除行么', function(index){
					$.post("/dept/deleteDept",{id:data.id},function () {
				...
				location.href="/dept/editDept?id="+data.id;
			}
		});
	});
</script>
