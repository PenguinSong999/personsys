...
<body oncontextmenu="self.event.returnValue=false" onselectstart="return false" >
    <div style="width: 100%;height:50px; background-color:RGB(43,48,59) ">
    ...
    <div id="main" style="width:100%;height:750px;float:left;">
          
      <div class="container" style="background-color:rgb(73,74,95);width: 100%;height:750px;float:left;">
            ...
            <form  method="post" action="${pageContext.request.contextPath}/login" name="check-form" id="toLoginForm">
                ...
                <div class="default">
                    <input id="password" name="password"
									value="admin" data-form="upwd" type="password" placeholder="请输入账号密码 " />
                </div>
              ...
              <div class="default" >
                    ...
                    <div class="vcode" id="vcodeDiv" style="float: right;">
			          		...
			          		<input name="code" type="hidden" id="code" value="${checkcode}" />
			         	</div>
                </div> 
       ...
       <!-- 底部开始 -->
     <div style="width: 100%;height:50px;background-color:RGB(43,48,59) ;margin-top:610px;">
