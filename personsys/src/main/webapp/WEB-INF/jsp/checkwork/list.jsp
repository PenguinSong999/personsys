      ...
      layui.use('table', function(){
          ...
          table.render({
              ...
              ,cols: [[
                  ...
                  ,{field:'workingdays', width:120, title: '工作天数', align: 'center'}
                  ,{field:'daysleave', width:120, title: '请假天数', align: 'center'}
                  ,{field:'daysout', width:120, title: '旷工天数', align: 'center'}
          ...
          table.on('tool(demo)', function(obj){
              ...
              if(obj.event === 'del'){
                  layer.confirm('真的删除行么', function(index){
                      $.post("/checkwork/delete",{id:data.id},function () {
                  ...
                  location.href="/checkwork/edit?id="+data.id;
              }*/
          });
      });
  </script>
