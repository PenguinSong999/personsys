      ...
      layui.use('table', function(){
          ...
          table.render({
              ...
              ,cols: [[
                  ...
                  ,{field:'name', width:150, title: '职位', align: 'center'}
                  ,{field:'remark', width:150, title: '信息', align: 'center'}
          ...
          table.on('tool(demo)', function(obj){
              ...
              if(obj.event === 'del'){
                  layer.confirm('真的删除行么', function(index){
                      $.post("/job/deletejob",{id:data.id},function () {
                  ...
                  location.href="/job/editjob?id="+data.id;
              }
          });
      });
  </script>
