...
<html>
  ...
  <body>
    <div class="x-nav">
      ...
      <button type="button" onclick="location.href='${pageContext.request.contextPath}/salary/addpage'" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:inherit;margin-left:75%;"  ><i class="layui-icon"></i>增加</button>
      <a id="bbb" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${pageContext.request.contextPath}/salary/listdata" title="刷新">
      ...
      layui.use('table', function(){
          ...
          table.render({
              ...
              ,cols: [[
                  ...
                  ,{field:'salaryStation', width:120, title: '基本工资', align: 'center'}
                  ,{field:'salaryLevel', width:120, title: '工资水平', align: 'center'}
                  ,{field:'seniorityPay', width:120, title: '工龄工资', align: 'center'}
                  ,{field:'performance', width:120, title: '绩效', align: 'center'}
                  ,{field:'individualIncome', width:120, title: '个人收入', align: 'center'}
          ...
          table.on('tool(demo)', function(obj){
              ...
              if(obj.event === 'del'){
                  layer.confirm('真的删除行么', function(index){
                      $.post("/salary/delete",{id:data.id},function () {
                  ...
                  location.href="/salary/editpage?id="+data.id;
              }
          });
      });
  </script>
